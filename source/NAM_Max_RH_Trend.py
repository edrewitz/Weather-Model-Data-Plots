...
plt.suptitle('NAM 3-Day Max RH Change', fontsize=24, fontweight='bold')
plt.axis('off')
...
if hour >= 3 and hour < 9:
    #### Initial Forecast ####
    cs = ax.contourf(lon_vals, lat_vals, data[4, :, :], transform=ccrs.PlateCarree(), cmap='BrBG', levels=np.arange(0, 100, 5))
    cbar = fig.colorbar(cs, shrink=0.7)
    cbar.set_label(label="Max Relative Humidity (%)", size=8, fontweight='bold')
    ax.set_title('Max RH Forecast | Valid: ' + forecast_time_1.strftime('%m/%d/%Y %HZ'), fontweight='bold', fontsize=12) 

    #### Night 1 Forecast Trend ####
    cs1 = ax1.contourf(lon_vals, lat_vals, (data[12, :, :] - data[4, :, :]), transform=ccrs.PlateCarree(), cmap='BrBG', levels=np.arange(-50, 50, 5))
    cbar1 = fig.colorbar(cs1, shrink=0.7)
    cbar1.set_label(label="Max Relative Humidity Change (%)", size=8, fontweight='bold')
    ax1.set_title('Max RH Trend Forecast | Valid: ' + forecast_time_2.strftime('%m/%d/%Y %HZ'), fontweight='bold', fontsize=10)    

    #### Night 2 Forecast Trend ####
    cs2 = ax2.contourf(lon_vals, lat_vals, (data[20, :, :] - data[12, :, :]), transform=ccrs.PlateCarree(), cmap='BrBG', levels=np.arange(-50, 50, 5))
    cbar2 = fig.colorbar(cs2, shrink=0.7)
    cbar2.set_label(label="Max Relative Humidity Change (%)", size=8, fontweight='bold')
    ax2.set_title('Max RH Trend Forecast | Valid: ' + forecast_time_3.strftime('%m/%d/%Y %HZ'), fontweight='bold', fontsize=10) 

    #### Night 3 Forecast Trend ####
    cs3 = ax3.contourf(lon_vals, lat_vals, (data[28, :, :] - data[20, :, :]), transform=ccrs.PlateCarree(), cmap='BrBG', levels=np.arange(-50, 50, 5))
    cbar3 = fig.colorbar(cs3, shrink=0.7)
    cbar3.set_label(label="Max Relative Humidity Change (%)", size=8, fontweight='bold')
    ax3.set_title('Max RH Trend Forecast | Valid: ' + forecast_time_4.strftime('%m/%d/%Y %HZ'), fontweight='bold', fontsize=10)
    
#### 06z Run ####
if hour >= 9 and hour < 15:
    
    #### Initial Forecast ####
    cs = ax.contourf(lon_vals, lat_vals, data[2, :, :], transform=ccrs.PlateCarree(), cmap='BrBG', levels=np.arange(0, 100, 5))
    cbar = fig.colorbar(cs, shrink=0.8)
    cbar.set_label(label="Max Relative Humidity (%)", size=8, fontweight='bold')
    ax.set_title('Max RH Forecast | Valid: ' + forecast_time_1.strftime('%m/%d/%Y %HZ'), fontweight='bold', fontsize=12) 

    #### Night 1 Forecast Trend ####
    cs1 = ax1.contourf(lon_vals, lat_vals, (data[10, :, :] - data[2, :, :]), transform=ccrs.PlateCarree(), cmap='BrBG', levels=np.arange(-50, 50, 5))
    cbar1 = fig.colorbar(cs1, shrink=0.8)
    cbar1.set_label(label="Max Relative Humidity Change (%)", size=8, fontweight='bold')
    ax1.set_title('Max RH Trend Forecast | Valid: ' + forecast_time_2.strftime('%m/%d/%Y %HZ'), fontweight='bold', fontsize=10)    

    #### Night 2 Forecast Trend ####
    cs2 = ax2.contourf(lon_vals, lat_vals, (data[18, :, :] - data[10, :, :]), transform=ccrs.PlateCarree(), cmap='BrBG', levels=np.arange(-50, 50, 5))
    cbar2 = fig.colorbar(cs2, shrink=0.8)
    cbar2.set_label(label="Max Relative Humidity Change (%)", size=8, fontweight='bold')
    ax2.set_title('Max RH Trend Forecast | Valid: ' + forecast_time_3.strftime('%m/%d/%Y %HZ'), fontweight='bold', fontsize=10) 

    #### Night 3 Forecast Trend ####
    cs3 = ax3.contourf(lon_vals, lat_vals, (data[26, :, :] - data[18, :, :]), transform=ccrs.PlateCarree(), cmap='BrBG', levels=np.arange(-50, 50, 5))
...
if hour >= 15 and hour < 21:
    #### Initial Forecast ####
    cs = ax.contourf(lon_vals, lat_vals, data[8, :, :], transform=ccrs.PlateCarree(), cmap='BrBG', levels=np.arange(0, 100, 5))
    cbar = fig.colorbar(cs, shrink=0.6)
    cbar.set_label(label="Max Relative Humidity (%)", size=8, fontweight='bold')
    ax.set_title('Max RH Forecast | Valid: ' + forecast_time_1.strftime('%m/%d/%Y %HZ'), fontweight='bold', fontsize=12) 

    #### Night 1 Forecast Trend ####
    cs1 = ax1.contourf(lon_vals, lat_vals, (data[16, :, :] - data[8, :, :]), transform=ccrs.PlateCarree(), cmap='BrBG', levels=np.arange(-50, 50, 5))
    cbar1 = fig.colorbar(cs1, shrink=0.6)
    cbar1.set_label(label="Max Relative Humidity Change (%)", size=8, fontweight='bold')
    ax1.set_title('Max RH Trend Forecast | Valid: ' + forecast_time_2.strftime('%m/%d/%Y %HZ'), fontweight='bold', fontsize=10)    

    #### Night 2 Forecast Trend ####
    cs2 = ax2.contourf(lon_vals, lat_vals, (data[24, :, :] - data[16, :, :]), transform=ccrs.PlateCarree(), cmap='BrBG', levels=np.arange(-50, 50, 5))
...
if hour >= 21 or hour < 3:
    #### Initial Forecast ####
    cs = ax.contourf(lon_vals, lat_vals, data[6, :, :], transform=ccrs.PlateCarree(), cmap='BrBG', levels=np.arange(0, 100, 5))
    cbar = fig.colorbar(cs, shrink=0.6)
    cbar.set_label(label="Max Relative Humidity (%)", size=8, fontweight='bold')
    ax.set_title('Max RH Forecast | Valid: ' + forecast_time_1.strftime('%m/%d/%Y %HZ'), fontweight='bold', fontsize=12) 

    #### Night 1 Forecast Trend ####
    cs1 = ax1.contourf(lon_vals, lat_vals, (data[14, :, :] - data[6, :, :]), transform=ccrs.PlateCarree(), cmap='BrBG', levels=np.arange(-50, 50, 5))
    cbar1 = fig.colorbar(cs1, shrink=0.6)
    cbar1.set_label(label="Max Relative Humidity Change (%)", size=8, fontweight='bold')
    ax1.set_title('Max RH Trend Forecast | Valid: ' + forecast_time_2.strftime('%m/%d/%Y %HZ'), fontweight='bold', fontsize=10)    

    #### Night 2 Forecast Trend ####
    cs2 = ax2.contourf(lon_vals, lat_vals, (data[22, :, :] - data[14, :, :]), transform=ccrs.PlateCarree(), cmap='BrBG', levels=np.arange(-50, 50, 5))
    cbar2 = fig.colorbar(cs2, shrink=0.6)
    cbar2.set_label(label="Max Relative Humidity Change (%)", size=8, fontweight='bold')
    ax2.set_title('Max RH Trend Forecast | Valid: ' + forecast_time_3.strftime('%m/%d/%Y %HZ'), fontweight='bold', fontsize=10)     

plt.savefig("NAM_Max_RH_Trends")
